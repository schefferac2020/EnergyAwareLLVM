...
class env_wrapper(gym.Env):
    """
    credit to https://github.com/ymahlau/ppo_compiler_gym/
    ...
    def __init__(self, benchmarks, max_episode_steps=None, steps_in_observation=False):
    ...
    def switch_benchmark(self):
        ...
        print("Switched to {0} benchmark".format(self.benchmarks[idx]))
        self.env.close()
